...
import com.alipay.sofa.dashboard.client.dimension.actuator.ActuatorThreadSummaryDimension;
...
public class ThreadSummaryTest {
    ...
    public void basicInvokeTest() {
        Assert.assertEquals(dimension.getName(), RecordName.THREAD_SUMMARY);
